...
from diffusers import StableDiffusionUpscalePipeline, StableDiffusionPipeline, StableDiffusionPanoramaPipeline
import torch
import numpy as np
...
pipeline = StableDiffusionPanoramaPipeline.from_pretrained(model_id, torch_dtype=torch.float16)
